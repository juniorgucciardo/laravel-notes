                ...
                <div class=" bg-white p-6 flex justify-center items-center border-b border-gray-200">
                 ...
                 <div class="card max-w-md shadow py-8 px-4 rounded bg-yellow-50">
                   <div class="head-card text-center">
                     <span class="font-semibold text-xl text-yellow-600 leading-tight">Crie uma nova categoria</span>
                   </div>
                   <div class="body-card my-6">
                     <form class="block " method="POST"  action="{{ route('categories.create') }}">
                       @csrf
                       <label class="block w-full" for="">Titulo da categoria:</label>
                       <input placeholder="titulo" name="title" class="w-full rounded h-8"type="text">
                       <div class="row flex justify-between">
                        <div class="flex-col max-w-full my-2">
                          <label  for="">Cor de destaque:</label>
                          <input placeholder="yellow-200" name="color" class=" h-8 rounded "  type="text">
                        </div>
                        <div class="flex-col max-w-full my-2 ">
                          <label for="">Icone:</label>
                          <input placeholder="<i class=fas fa fas-icons></i>"  name="icon" class=" h-8 rounded "  type="text">
                        </div>
                       </div>
                     </div>
